...
BitSumCreationOperator::BitSumCreationOperator(GenotypeBlueprint* genotype_blueprint) : CreationOperator(genotype_blueprint) {
    ...
    if (auto const bit_sum_genotype_blueprint = dynamic_cast<BitSumGenotypeBlueprint*>(genotype_blueprint); bit_sum_genotype_blueprint == nullptr) {
...
Genotype* BitSumCreationOperator::create() {
    auto const bit_sum_genotype_blueprint = dynamic_cast<BitSumGenotypeBlueprint*>(this->genotype_blueprint);
