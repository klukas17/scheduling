...
int main(int argc, char* argv[]) {
    ...
    // *******************************
    int max_number_of_nodes = 300;
    double perturbation_rate = 0.2;
    int max_nodes_to_delete = 1;
    int max_nodes_to_insert = 4;
    int max_number_of_nodes_to_crossover = 10;
    double proceed_in_branch_chance = 0.6;
    ...
    auto sub_blueprint = new GraphBasedGeneticProgrammingGenotypeBlueprint(
        max_number_of_nodes,
        -1,
        1
    );
    auto sub_creation_operator = new GraphBasedGeneticProgrammingCreationOperator(sub_blueprint);
    auto sub_combination_operator = new GraphBasedGeneticProgrammingCombinationOperator(
        sub_blueprint,
        max_number_of_nodes_to_crossover,
        proceed_in_branch_chance
    );
    auto sub_perturbation_operator = new GraphBasedGeneticProgrammingPerturbationOperator(
        sub_blueprint,
        perturbation_rate,
        max_nodes_to_delete,
        max_nodes_to_insert
    );
    auto sub_serialization_operator = new GraphBasedGeneticProgrammingSerializationOperator(sub_blueprint);
    ...
    auto topology_enumerator = new RandomPathTopologyEnumerator(topology, 0.8);
