...
int main() {
    ...
    // ********************************************************************************
    hyperparameter_domains["nn_creation_sigma"] = {0.001, 0.01, 0.1, 1.0};
    hyperparameter_domains["nn_perturbation_sigma"] = {0.001, 0.01, 0.1, 1.0};
    hyperparameter_domains["nn_activation_function_name"] = {"sigm", "relu", "tanh", "lrelu"};
    hyperparameter_domains["nn_layer_sizes"] = {
        std::vector{1},
        std::vector{5, 1},
        std::vector{10, 1},
        std::vector{20, 1},
        ...
        std::vector{20, 10, 1},
        std::vector{20, 20, 1},
        std::vector{10, 10, 5, 1},
        std::vector{20, 10, 5, 1},
        std::vector{20, 20, 10, 1},
        std::vector{20, 15, 10, 5, 1}
    };
    ...
    auto evaluation_function = new HyperparameterTuningEvaluationFunctionNN(
        topology,
        jobs_train_set,
        jobs_test_set,
