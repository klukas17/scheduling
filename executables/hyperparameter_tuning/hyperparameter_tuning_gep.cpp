...
int main() {
    ...
    hyperparameters = {
        ...
        //**************************************************
        "gep_head_size",
        "gep_tail_chance_of_param",
        "gep_perturbation_rate",
        "gep_chance_of_transposition",
        "gep_transposition_max_length"
    };
    ...
    // ********************************************************************************
    hyperparameter_domains["gep_head_size"] = {10, 20, 30, 40, 50};
    hyperparameter_domains["gep_tail_chance_of_param"] = {0.5, 0.6, 0.7, 0.8, 0.9};
    hyperparameter_domains["gep_perturbation_rate"] = {0.05, 0.1, 0.2, 0.3};
    hyperparameter_domains["gep_chance_of_transposition"] = {0.2, 0.4, 0.5, 0.6, 0.8};
    hyperparameter_domains["gep_transposition_max_length"] = {2, 5, 8, 10, 15, 20};
    ...
    auto evaluation_function = new HyperparameterTuningEvaluationFunctionGEP(
        topology,
        jobs_train_set,
        jobs_test_set,
