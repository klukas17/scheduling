...
int main() {
    ...
    // ********************************************************************************
    hyperparameter_domains["sge_max_depth"] = {3, 4, 5};
    hyperparameter_domains["sge_perturbation_rate"] = {0.05, 0.1, 0.2, 0.3};
    ...
    auto evaluation_function = new HyperparameterTuningEvaluationFunctionSGE(
        topology,
        jobs_train_set,
        jobs_test_set,
